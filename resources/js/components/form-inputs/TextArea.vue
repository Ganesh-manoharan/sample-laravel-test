<template>
  <div>
    ...
    <textarea :id="id" :min="0"  :type="inputType" class="form-control" :class="[(this.errorMessage) ? 'is-invalid' : '']" v-model="inputValue" :aria-describedby="helpId" :placeholder="placeholder" :maxlength="maxLengthTitle?maxLengthTitle:maxLength"></textarea>
